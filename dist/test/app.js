(function (factory) {
    ...
    class Widget {
        constructor(googleSheetLink, isHidden, platformName, os) {
            ...
            this.stylesLink = (window.location.host === 'localhost:1001') ? 'app.css' : (window.location.host === 'bugboxio.netlify.app') ? 'https://sashaux.github.io/bugbox/dist/test/app-min.css' : 'https://sashaux.github.io/bugbox/dist/prod/app-min.css';
